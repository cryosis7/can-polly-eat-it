...
export const guidanceLists: GuidanceList[] = [
  {
    ...
    sourceIds: ['new-zealand-food-safety'],
    ...
    statuses: [
      ...
      { id: 'pregnancy-avoid', slug: 'avoid', label: 'Avoid', tone: 'red', outcomeBand: 'not-okay', sortOrder: 3, filterLabel: 'Avoid', summary: 'The guide says not to eat this during pregnancy.' },
      { id: 'pregnancy-not-assessed', slug: 'not-assessed', label: 'Not assessed', tone: 'grey', outcomeBand: 'not-assessed', sortOrder: 4, filterLabel: 'Not assessed', summary: 'This item has not been added to this guide yet, so it has not been assessed.' },
    ],
    unassessedNotice: {
