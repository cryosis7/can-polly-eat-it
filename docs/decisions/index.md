...
| [2026-09-21 ADR: enforce local quality gates](<2026-09-21 ADR - enforce local quality gates.md>) | Accepted | Vitest coverage, Playwright journeys, axe scans, type-checking, linting, and builds protect the local-only delivery workflow, with coverage and browser tests enforced pre-commit. |
