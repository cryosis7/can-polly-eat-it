...
4. On a narrow viewport, open the native `Filters` disclosure to select category, display-list, or
   status controls; on a wider viewport, use the same controls without concealing them.
