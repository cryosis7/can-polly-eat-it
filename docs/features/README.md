...
| F-16 | [Express guidance that accumulates across subject levels](<16-express-accumulating-guidance.md>) | Planned | F-04, F-09 | See every instruction a source gives about a food, not only its most specific one. |
