...
| F-17 | [Support multiple sources within one guidance list](<17-support-multiple-sources-per-guidance-list.md>) | Proposed | F-04, F-05, F-08, F-10, F-16 | See what every reviewed authority says about a food, and decide when they disagree. |
