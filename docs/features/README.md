...
| F-19 | [Make preparation bands collapsible](<19-make-preparation-bands-collapsible.md>) | Done | F-11, F-18 | Collapse preparation bands you do not need while keeping category breadcrumbs and guidance content unchanged. |
| F-20 | [Summarise collapsed rows with an aggregate status chip](<20-summarise-collapsed-rows-with-status-chip.md>) | Done | F-11, F-18, F-19 | Tell at a glance whether a collapsed group holds anything needing attention, without expanding it. |
