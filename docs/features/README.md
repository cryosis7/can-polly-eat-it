...
| F-15 | [Retire the outside-coverage state](<15-retire-outside-coverage-state.md>) | Planned | F-08, F-12, F-13 | Get one plain answer when a guide has nothing to say about a food. |
