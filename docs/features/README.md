...
| F-12 | [Lift group-level guidance onto categories](<12-lift-group-guidance-onto-categories.md>) | Planned | F-04, F-09, F-11 | Show a group-wide rule once against its group instead of repeating it on near-identical entries. |
...
| F-15 | [Retire the outside-coverage state](<15-retire-outside-coverage-state.md>) | Proposed | F-08, F-12, F-13 | Get one plain answer when a guide has nothing to say about a food. |
| F-16 | [Express guidance that accumulates across subject levels](<16-express-accumulating-guidance.md>) | Proposed | F-04, F-09 | See every instruction a source gives about a food, not only its most specific one. |
