...
| F-05 | [Add independent guidance lists](<05-add-independent-guidance-lists.md>) | Proposed | F-01, F-02, F-03, F-04 | Filter one catalogue by selected dietary scopes and generic outcomes. |
