...
/**
 * Regenerates the F-18 pre-migration snapshot. Run before any content moves:
...
const banner = `// Generated by scripts/snapshotPreF18.ts before the F-18 content migration.
